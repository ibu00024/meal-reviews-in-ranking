...
class ReviewSubmitDTO {
    ...
    constructor(restaurantId: number, categoryId: number, imageURL: string, rating: number, price: number, menuName: string, comments: string, reviewer: string | undefined) {
